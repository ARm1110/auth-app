...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <div class="container px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">tasks.index
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="{{ route('tasks.create') }}">take task</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('users.showLogin') }}">Login</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('users.showRegister') }}">Register</a></li>
            ...
            <div class="row gx-4 justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead">This is a great place to talk about your webpage. This template is purposefully
                        unstyled so you can use it as a boilerplate or starting point for you own landing page designs! This
                        template features:</p>
                    <ul>
